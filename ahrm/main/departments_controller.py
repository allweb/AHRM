...
def department_save(request):
    ...
    if request.POST['dep_name']!='' and request.POST['dep_desc']!='' :            
        ...
        if request.POST['dep_name']=='':
            data['error_dep_name'] = ugettext('Department Name could not be blank')
        else:
            data['error_dep_name'] = ''
        if request.POST['dep_desc']=='':
            data['error_dep_desc'] = ugettext('Department Describtion could not be blank')
        else:
            data['error_dep_desc'] = ''                       
        data['id'] = ses.company_id
...
def department_save(request):
    ...
    if request.POST['dep_name']!='' and request.POST['dep_desc']!='' :            
        ...
        if request.POST['dep_name']=='':
            data['error_dep_name'] = 'Department Name could not be blank'
        else:
            data['error_dep_name'] = ''
        if request.POST['dep_desc']=='':
            data['error_dep_desc'] = 'Department Describtion could not be blank'
        else:
            data['error_dep_desc'] = ''                       
        data['id'] = ses.company_id
        data['name'] = request.POST['dep_father']
