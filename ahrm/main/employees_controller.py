...
def employee_tabs(emp_id):
    tabs = Tabs()
    personal = TabElement('personal', 'Personal Info', '/employee/edit/' + str(emp_id), 'employees/employee_create_in_dept.html')
    department = TabElement('department', 'Department', '/employee/department', 'employees/employee_departement.html')
    emergency = TabElement('emergency', 'Emergency', '/employee/emergency', 'employees/employee_emergency.html')
    experience = TabElement('experience', 'Experience', '/employee/experience', 'employees/employee_experience.html')
    education = TabElement('education', 'Education', '/employee/education', 'employees/employee_education.html')
    skill = TabElement('skill', 'Skill', '/employee/skill', 'employees/employee_skill.html')
    language = TabElement('language', 'Language', '/employee/languages', 'employees/employee_language.html')
    attachment = TabElement('attachment', 'Attachment', '/employee/attachment', 'employees/employee_attachment.html')
